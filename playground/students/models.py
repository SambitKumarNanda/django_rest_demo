...
class PrevEducationModel(models.Model):
    ...
    address = models.ForeignKey(AddressDetailModel, on_delete=models.CASCADE, related_name="prev_education_address",
                                null=True)  # 1
...
class StudentPrevEducationModel(models.Model):
    ...
    address = models.ForeignKey(AddressDetailModel, on_delete=models.CASCADE,
                                related_name="student_prev_education_address", null=True)
